...
import { Zap, Globe, Clock, BarChart2, ShieldCheck, Cpu, ArrowUpRight } from "lucide-react";
...
const reasons = [
  {
    id: "01",
    icon: Zap,
    title: "One Agency. Everything.",
    body: "Web development, SEO, marketing, and content — all under one roof, one strategy, zero miscommunication. No more managing five vendors with five different agendas.",
    size: "large",
    color: "#6324FC"
  },
  {
    id: "02",
    icon: Globe,
    title: "Western Market Expertise",
    body: "We don't just speak English — we understand US, UK, and Australian consumer psychology, search intent, and buying patterns that actually convert into paying clients.",
    size: "small",
    color: "#00E5FF"
  },
  {
  ...
  },
  {
    ...
    body: "We agree on clear KPIs before every engagement begins. If we don't hit them, we keep working until we do — at no extra cost. No excuses, no fine print, just results.",
    size: "large",
    color: "#00FFA3"
  }
];
...
function FeatureCard({ item, index }: { item: typeof reasons[0], index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-[2.5rem] bg-white/[0.01] backdrop-blur-3xl border border-white/[0.05] p-12 transition-all duration-700 hover:border-[#6324FC]/30 flex flex-col justify-between shadow-[0_40px_80px_rgba(0,0,0,0.4)] ${
        index === 0 || index === 3 ? "md:col-span-3" : "md:col-span-3 lg:col-span-3"
      }`}
    >
      ...
      <motion.div
        ...
        style={{
          background: useTransform(
            [mouseX, mouseY],
            ([x, y]) => `radial-gradient(400px circle at ${x}px ${y}px, ${item.color}15, transparent 40%)`
          ),
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-16">
          ...
          >
            ...
            <item.icon className="w-10 h-10 transition-all duration-500 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" style={{ color: item.color }} />
          </motion.div>
        ...
        <div className="space-y-6">
          <h3 className="font-heading text-3xl md:text-4xl tracking-tight text-white mb-4 group-hover:text-[#6324FC] transition-colors duration-500">
            {item.title}
          </h3>
          
          <p className="font-sans font-light text-2xl text-white/30 leading-relaxed max-w-xl group-hover:text-white/70 transition-colors duration-500">
            {item.body}
          </p>
        </div>
      </div>
    ...
    <section className="w-full bg-[#060608] py-20 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="mb-24">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <h2 className="font-heading text-8xl md:text-[9rem] tracking-tighter text-white leading-[0.85] uppercase">
              THE INJAAZH <br/>
              <span className="stroke-text text-transparent italic opacity-40">ADVANTAGE.</span>
            </h2>
            <div className="max-w-md">
              <p className="font-sans font-light text-white/40 text-xl leading-relaxed mb-10 border-l-2 border-[#6324FC]/20 pl-8">
                We don't just build websites — we engineer complete digital ecosystems that attract the right audience, convert visitors into clients, and generate revenue while you sleep.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
          ...
          >
            <div className="w-full h-full bg-[#060608]/95 backdrop-blur-3xl rounded-[2.9rem] p-10 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 transition-colors group-hover:bg-transparent">
              ...
              <div className="flex flex-col lg:items-start text-center lg:text-left">
                 ...
                 <h2 className="font-heading text-4xl md:text-6xl text-white leading-none tracking-tighter mb-6 uppercase">
                    Get Your <br/><span className="italic text-[#00E5FF]">Free Audit</span>
                 </h2>
                 <p className="font-sans text-white/40 text-xl max-w-xl">
              ...
              <div className="relative flex-shrink-0">
                 <motion.button 
                   ...
                   whileTap={{ scale: 0.95 }}
                   className="px-12 py-6 bg-white text-black rounded-2xl font-heading text-2xl tracking-widest shadow-[0_20px_50px_rgba(255,255,255,0.1)] group-hover:bg-[#6324FC] group-hover:text-white transition-all flex items-center gap-4"
                 >
