...
function FeatureCard({ item, index }: { item: typeof reasons[0], index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-[2.5rem] bg-white/[0.01] backdrop-blur-3xl border border-white/[0.05] p-8 md:p-12 transition-all duration-700 hover:border-[#6324FC]/30 flex flex-col justify-between shadow-[0_40px_80px_rgba(0,0,0,0.4)] ${
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-6">
          ...
          <p className="font-sans font-light text-xl md:text-2xl text-white/60 leading-relaxed max-w-xl group-hover:text-white/90 transition-colors duration-500">
            {item.body}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="mb-24">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <h2 className="font-heading text-6xl sm:text-7xl md:text-[6.5rem] lg:text-[8rem] tracking-tighter text-white leading-[0.85] uppercase">
              THE INJAAZH <br/>
