...
export default function DigitalExperience() {
  ...
  const content = [
    {
      ...
      kpis: [
        { label: "PAGE SPEED", val: "99" },
        { label: "UPTIME", val: "99.9%" },
      ],
      bars: [
        { label: "PERFORMANCE", width: "98%" },
        { label: "ACCESSIBILITY", width: "100%" },
        { label: "SECURITY SCORE", width: "95%" },
      ],
    ...
    },
    {
      ...
      kpis: [
        { label: "TRAFFIC GROWTH", val: "340%" },
        { label: "RANKING", val: "Top 3" },
      ],
      bars: [
        { label: "AUTHORITY", width: "88%" },
        { label: "TRUST FLOW", width: "92%" },
        { label: "INDEX RATE", width: "100%" },
      ],
    ...
    },
    {
      ...
      kpis: [
        ...
        { label: "CPA CUT", val: "40%" },
      ],
      bars: [
        { label: "CONV. RATE", width: "8.5%" },
        { label: "RETENTION", width: "90%" },
        { label: "MARKET FIT", width: "95%" },
      ],
      cta: "LAUNCH CAMPAIGN",
    },
    {
      ...
      kpis: [
        { label: "ENGAGEMENT", val: "+120%" },
        { label: "READ TIME", val: "4m 20s" },
      ],
      bars: [
        { label: "READABILITY", width: "96%" },
        { label: "SEO SCORE", width: "100%" },
        { label: "VOICE SYNC", width: "92%" },
      ],
    ...
    },
    {
      ...
      kpis: [
        { label: "SHARE", val: "+25%" },
        { label: "GROWTH", val: "Exp" },
      ],
      bars: [
        { label: "ALIGNMENT", width: "100%" },
        { label: "UX MATURITY", width: "88%" },
        { label: "VELOCITY", width: "95%" },
      ],
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 md:py-24 bg-[#060608] transition-colors duration-500 overflow-hidden border-t border-white/[0.03]"
    >
      <h2 className="sr-only">
        Our Premium Digital Services: Web Development, SEO, and Marketing
      </h2>
            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-heading  text-[10px] tracking-[0.5em] text-[#6324FC] capitalize ">
                  ...
                  {content[activeTab].headlineSegments.map((seg, idx) => {
                    if (seg.type === "purple") {
                      return (
                        <span
                          key={idx}
                          className="inline-block italic text-[#6324FC]"
                        >
                          {seg.text}
                        </span>
                      );
                ...
                <div className="flex flex-wrap gap-3">
                  {content[activeTab].tags.map((tag, idx) => (
                    <div
                      key={idx}
                      className="px-4 py-2 bg-[#6324FC]/10 border border-[#6324FC]/30 font-heading  text-[10px] tracking-widest text-white/90 capitalize rounded-full whitespace-nowrap shadow-[0_0_15px_rgba(99,36,252,0.1)]"
                    >
                      {tag}
                    </div>
                  ))}
                ...
                >
                  ...
                  <div className="relative w-full h-full px-8 py-4 md:px-12 md:py-5 rounded-full bg-[#F5F5F0] dark:bg-[#060608] transition-colors duration-500 flex items-center justify-center gap-3 z-10">
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-4 font-heading text-lg tracking-tighter text-primary capitalize text-center">
              ...
              <div className="relative group perspective-[1000px]">
                ...
                >
                  ...
                  <div
                    className="grid grid-cols-2 gap-6 md:gap-12 mb-10 md:mb-16"
