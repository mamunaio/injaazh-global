          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-8 sm:gap-12 md:gap-16 px-4 sm:px-6 md:px-8">
              {marqueeRow1.map((item, idx) => (
                ...
                >
                  <span className="font-heading text-4xl sm:text-6xl md:text-[6rem] leading-none uppercase tracking-tighter text-white">
                    {item.label}
                  </span>
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-8 sm:gap-12 md:gap-16 px-4 sm:px-6 md:px-8">
              {marqueeRow2.map((item, idx) => (
                ...
                >
                  <span className="font-heading text-4xl sm:text-6xl md:text-[6rem] leading-none uppercase tracking-tighter transition-colors duration-300 text-white/40 group-hover/link:text-[#00E5FF]">
                    {item.label}
                  </span>
