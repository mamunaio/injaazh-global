...
import { Minus, Plus, ArrowUpRight, ArrowRight } from "lucide-react";
...
export default function UiUxDesignClient() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#060608] text-white pt-32 pb-20 font-sans overflow-hidden">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <p className="font-sans font-light text-lg text-white/50 leading-relaxed max-w-3xl mb-12 border-l border-white/10 pl-8">
            ...
            <br />
            <br />
            At Injaazh, we design digital experiences that stop the scroll,
            build instant trust, and guide users toward one outcome — taking
            action. Every pixel is intentional. Every interaction is engineered.
          </p>
      ...
      {/* Stats Strip */}
      <section className="border-y border-white/5 bg-white/[0.01] py-12 md:py-16 backdrop-blur-md">
        <div className="max-w-[1400px] mx-auto grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/5">
          {stats.map((stat, i) => (
            <div key={i} className="py-12 px-6 text-center hover:bg-white/[0.02] transition-all duration-500 group relative overflow-hidden">
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
                <div className="absolute -inset-10 bg-[#6324FC]/5 blur-2xl rounded-full" />
              </div>
              <div className="font-heading text-5xl md:text-7xl mb-2 bg-gradient-to-b from-white via-white to-white/50 bg-clip-text text-transparent group-hover:from-[#6324FC] group-hover:to-[#d946ef] transition-all duration-700 uppercase">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {whatIsIncluded.map((item, i) => (
              ...
              >
                <div>
                  <h3 className="font-heading text-3xl mb-4 text-white group-hover:text-[#6324FC] transition-colors duration-500">{item.title}</h3>
            ...
            {process.map((step, i) => (
              ...
              >
                ...
                <div className="relative z-10 pt-8">
                  ...
                  <h3 className="font-heading text-xl text-white mb-3 group-hover:text-[#6324FC] transition-colors duration-500">{step.title}</h3>
