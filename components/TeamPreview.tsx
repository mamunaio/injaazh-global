      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-16">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading text-5xl md:text-7xl tracking-tighter text-primary leading-[0.85] capitalize ">
              THE MINDS BEHIND <br />
              <span className="stroke-text italic opacity-80">INJAAZH.</span>
            </h2>
          </div>
          <motion.div
            ...
            className="max-w-sm"
          >
            <p className="font-sans font-light text-primary/50 leading-relaxed border-l-2 border-[#6324FC] pl-8">
              A global squad of elite digital architects, growth engineers, and
              SEO strategists — built to outperform agencies ten times our size.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16 md:mb-20">
          {teamPreviewData.map((member, idx) => (
            <motion.div
              ...
              className="group relative aspect-[3/4] rounded-[2.5rem] border border-[#060608]/10 dark:border-white/5 hover:border-[#6324FC]/40 transition-all duration-700 overflow-hidden backdrop-blur-xl bg-[#EEECEA] dark:bg-white/[0.02]"
            >
              ...
              {/* Always-dark cinematic vignette for text readability */}
              ...
              {/* Vertical ID Number */}
              <div className="absolute top-8 left-8 font-heading text-4xl opacity-[0.03] group-hover:opacity-10 transition-opacity duration-700 text-sky-100 select-none">
                {member.id}
              </div>
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col z-10">
                ...
                <div className="inline-flex w-fit px-3 py-1.5 bg-[#6324FC]/30 backdrop-blur-md border border-[#6324FC]/40 rounded-full font-heading text-[9px] md:text-[10px] tracking-[0.2em] text-sky-100 capitalize mb-4 whitespace-nowrap group-hover:bg-[#6324FC] group-hover:border-[#6324FC] group-hover:text-sky-100 transition-all duration-500">
                  {member.role}
                </div>

                {/* Name - always white since it sits over the dark image gradient */}
                <h3 className="font-heading text-3xl tracking-tight text-sky-100 mb-2 leading-none group-hover:text-[#6324FC] transition-colors duration-500">
                ...
                <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]">
                  <div className="overflow-hidden">
                    <p className="font-sans font-light text-[13px] text-sky-100/60 leading-relaxed pt-4 pb-6 group-hover:text-sky-100/80 transition-colors">
                      {member.bio}
                    </p>
                    <div className="flex gap-5 border-t border-white/20 pt-6">
                      <Link
                        href="#"
                        className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-sky-100/60 hover:text-sky-100 hover:border-white/50 hover:bg-white/10 transition-all duration-300"
                      >
                        <Globe className="w-3.5 h-3.5" />
                      </Link>
                      <Link
                        href="#"
                        className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-sky-100/60 hover:text-[#6324FC] hover:border-[#6324FC] hover:bg-[#6324FC]/10 transition-all duration-300"
                      >
            ...
            >
              ...
              <div className="relative w-full h-full px-8 py-4 md:px-12 md:py-5 rounded-full bg-[#F5F5F0] dark:bg-[#060608] transition-colors duration-500 flex items-center justify-center gap-3 z-10">
                ...
                <span className="relative z-10 flex items-center justify-center gap-4 font-heading md:text-xl tracking-[0.2em] text-primary uppercase text-center">
                  ...
                  <ArrowRight className="w-5 h-5 -rotate-45 group-hover:rotate-0 transition-transform duration-500 text-[#6324FC] dark:group-hover:text-sky-100" />
                </span>
              </div>
            </motion.div>
