...
export default function PrivacyPolicy() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#060608] text-white relative overflow-hidden selection:bg-[#6324FC] selection:text-white">
      ...
      <div className="absolute inset-0 bg-[url('/assets/noise.svg')] opacity-[0.03] pointer-events-none mix-blend-overlay fixed" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <div className="font-heading  text-[#6324FC] tracking-[0.5em] text-[10px] capitalize mb-8 flex items-center gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-32">
          ...
          <div className="lg:w-1/3 hidden lg:block">
            <div className="sticky top-40 space-y-8">
              <h4 className="font-heading  text-[10px] text-white/30 tracking-widest capitalize mb-8">Table of Contents</h4>
              <nav className="flex flex-col gap-6 relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-[1px] before:bg-white/10">
                {SECTIONS.map((section) => (
                  <a 
                    key={section.id} 
                    href={`#${section.id}`}
                    className={`relative pl-8 font-heading  tracking-tight transition-all duration-300 ${activeSection === section.id ? 'text-[#6324FC]' : 'text-white/40 hover:text-white/80'}`}
                  >
          ...
          <div className="lg:w-2/3">
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <div className="space-y-32">
                {SECTIONS.map((section, idx) => (
                  ...
                  >
                    ...
                    <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter capitalize mb-12 text-[#00E5FF] border-b border-white/10 pb-8 relative z-10">
                      {section.title}
                    </h2>
              ...
              >
                ...
                <h3 className="font-heading text-4xl tracking-tight capitalize mb-6 text-white relative z-10">Enforce Your Rights</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-6 relative z-10">
                  <Link href="/contact" className="inline-flex items-center justify-center gap-3 px-8 py-5 bg-white text-black font-heading text-sm tracking-widest capitalize rounded-full hover:bg-[#00E5FF] transition-colors">
                    Contact Compliance <ArrowRight className="w-4 h-4" />
                  </Link>
                  <a href="mailto:dpo@injaazh.com" className="inline-flex items-center justify-center gap-3 px-8 py-5 border border-white/20 text-white font-heading text-sm tracking-widest capitalize rounded-full hover:bg-white/5 transition-colors">
                    Email DPO
                  </a>
                </div>
              </motion.div>
