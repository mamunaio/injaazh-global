...
export default function WebDevPage() {
  ...
  const whatWeBuild = [
    {
      ...
      desc: "The fastest way to build modern websites. We deploy headless Next.js infrastructures that guarantee 99/100 Lighthouse scores, sub-second load times, and seamless scalability for businesses that can't afford to be slow.",
    ...
    },
    {
      ...
      desc: "For complex needs that off-the-shelf solutions can't handle. We build robust, secure, and scalable web apps using the MERN stack, PHP, and Python — engineered precisely to your business logic and requirements.",
      tags: ["MONGODB", "EXPRESS", "REACT", "NODE.JS", "PYTHON"],
    },
    {
      title: "API & Backend Automation",
      desc: "Eliminate manual workflows and integrate your entire tech stack. We build custom API integrations and backend automation systems that save time, reduce errors, and dramatically improve operational efficiency.",
  ...
  const whyItWorks = [
    ...
    },
    {
      ...
      desc: "A beautiful website that doesn't convert is just an expensive brochure. We build with conversion rate optimization baked in from day one — layouts, copy, and flows engineered to turn visitors into leads.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your business goals, target audience, and technical requirements. Then we build a clear technical blueprint before a single line of code is written — so every decision has a reason.",
    },
    {
      id: "02",
      title: "Design & Prototype",
      desc: "Wireframes and interactive prototypes reviewed and approved by you — so there are zero surprises at launch. Awwwards-level aesthetics mapped to your conversion goals.",
    },
    {
      id: "03",
      title: "Development & Testing",
      desc: "Clean, modular, production-ready code. Tested across devices, browsers, and screen sizes before we ship anything. No shortcuts. No technical debt.",
    },
    {
      id: "04",
      title: "Launch & Optimize",
      desc: "We don't disappear after launch. Post-launch monitoring, performance optimization, and ongoing support — because your success after go-live is as important as the build itself.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      a: "Timelines depend on scope. A standard Next.js or WordPress site typically takes 3–6 weeks from brief to launch. Custom web applications range from 6–12 weeks. Every project starts with a clear technical blueprint so deadlines are set — and kept.",
    },
    {
      q: "Do you work with clients in the US and UK?",
      a: "Yes — the majority of our clients are based in the US, UK, Canada, and Australia. We operate across timezones with a guaranteed 24-hour response policy and dedicated project managers for every engagement.",
    },
    {
      q: "What platform do you recommend — WordPress or Next.js?",
      a: "It depends on your needs. WordPress is ideal for content-heavy sites, blogs, and WooCommerce stores where non-technical teams need easy editing. Next.js is the right choice for performance-critical, high-traffic, or headless architecture projects. We'll recommend the right stack after understanding your goals.",
    },
    {
      q: "Do you offer post-launch support?",
      a: "Yes. Every project includes a post-launch support window. We also offer ongoing retainer packages for performance monitoring, updates, and continuous optimization — so your site stays fast, secure, and competitive long after launch.",
    },
    {
      q: "What is your pricing?",
      a: "Pricing is scoped per project based on complexity, platform, and timeline. We don't do one-size-fits-all packages — every proposal is custom-built to your requirements. Send us your brief and we'll respond with a clear, detailed proposal within 24 hours.",
    },
  ];
  ...
  return (
    <main className="relative w-full min-h-screen bg-[#060608] text-white pt-32 font-sans overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-16 pb-16 md:pt-24 md:pb-24 border-b border-white/5 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <h1 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter capitalize mb-12">
            ...
            THAT PERFORM{" "}
            <span className="italic bg-gradient-to-r from-[#6324FC] to-[#d946ef] bg-clip-text text-transparent">
              GLOBALLY.
            </span>
          </h1>
          ...
          <p className="font-sans font-light text-lg text-white/50 leading-relaxed max-w-3xl mb-12 border-l border-white/10 pl-8">
            ...
            products that load fast, rank on Google, and convert visitors into
            paying clients.
            <br />
            <br />
            From Next.js headless architectures to custom WordPress solutions,
            every line of code we write is optimized for speed, security, and
            scale — across the US, UK, Australia, and beyond.
          </p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 bg-white/[0.01] backdrop-blur-md border border-white/5 rounded-3xl overflow-hidden divide-x divide-white/5">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="py-16 px-6 text-center hover:bg-white/[0.02] transition-all duration-500 group relative overflow-hidden"
              >
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {whatWeBuild.map((item, i) => (
              <div
                key={i}
                className="p-10 bg-white/[0.01] backdrop-blur-md border border-white/5 rounded-3xl hover:border-[#6324FC]/30 hover:shadow-[0_0_30px_rgba(99,36,252,0.1)] transition-all duration-500 group relative overflow-hidden"
              >
                {/* Icon */}
                ...
                <h3 className="font-heading text-3xl mb-4 group-hover:text-[#6324FC] transition-colors duration-500">
                  {item.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {process.map((step, i) => (
              ...
              >
                ...
                <h3 className="font-heading text-xl mb-3 group-hover:text-[#6324FC] transition-colors duration-500 relative z-10">
                  {step.title}
                </h3>
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`border border-white/5 rounded-2xl transition-all duration-500 ${isOpen ? "bg-white/[0.01] border-[#6324FC]/20" : "bg-transparent"}`}
                >
                  <button
                  ...
                  >
                    <span
                      className={`font-sans text-xl transition-colors duration-300 ${isOpen ? "text-[#6324FC]" : "text-white group-hover:text-[#6324FC]"}`}
                    >
                      {faq.q}
                    </span>
                    <div
                      className={`transform transition-transform duration-500 ${isOpen ? "rotate-45" : "rotate-0"}`}
                    >
                      <Plus
                        className={`w-5 h-5 ${isOpen ? "text-[#6324FC]" : "text-white/40 group-hover:text-[#6324FC]"}`}
                      />
                    </div>
                  </button>
                  <AnimatePresence>
      ...
      <section className="w-full bg-[#060608] py-16 md:py-24 relative overflow-hidden border-t border-white/5 text-center">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <p className="font-sans font-light text-xl text-white/50 max-w-2xl mx-auto mb-12">
            ...
            hours. No templates. No guesswork. Just a build scoped exactly to
