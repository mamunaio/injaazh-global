        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center mb-48">
          <div>
            ...
            >
              ...
              <span className="font-mono text-[#6324FC] text-[10px] tracking-[0.5em] uppercase">Software Division</span>
            </motion.div>
              ...
              <div className="relative aspect-square bg-[#0A0A0C] border border-white/10 rounded-3xl overflow-hidden shadow-2xl shadow-black p-10">
                 ...
                 <div className="relative z-10 h-full flex flex-col justify-between">
                    <div className="flex justify-between">
                       ...
                       <div className="font-mono text-[10px] text-white/20 uppercase tracking-widest">Dev Environment v9.0</div>
                    </div>
                    
                    <div className="space-y-4">
                       <div className="font-heading text-4xl text-white uppercase tracking-tighter">Full-Stack <br/>Control.</div>
                       <div className="flex gap-2">
                          <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                          <span className="font-mono text-[9px] text-white/40 uppercase">System Status: Operational</span>
                       </div>
                    </div>
                    
                    <div className="space-y-4 border-t border-white/5 pt-8">
                       {["Next.js", "Node.js", "PostgreSQL", "Redis", "AWS", "Docker"].map((tech, i) => (
                         <div key={i} className="flex items-center justify-between font-mono text-[10px] text-white/30 uppercase">
                            <span>{tech}</span>
                     ...
                     <div key={i} className="flex gap-6 group">
                        ...
                        <div className="space-y-2">
                           <div className="flex items-center gap-4">
                              <span className="font-heading text-2xl text-white uppercase">{item.label}</span>
                              <span className="font-mono text-[9px] text-[#00E5FF] tracking-widest uppercase">{item.val}</span>
                           </div>
