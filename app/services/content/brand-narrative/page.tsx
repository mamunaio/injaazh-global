  ...
  const features = [
    {
      ...
      description:
        "Defining the unique &quot;Why&quot; behind your brand and crafting a compelling journey from inception to industry leader.",
      icon: Anchor,
      color: "#6324FC",
    },
    {
      title: "Tone of Voice",
      description:
        "Developing a distinct verbal personality that cuts through the noise and resonates with your specific audience.",
      icon: MessageSquare,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Identifying the core emotional triggers that drive loyalty and building a narrative around them.",
      icon: Heart,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Ensuring your brand mission isn&apos;t just a paragraph, but a living story that inspires both customers and employees.",
      icon: Compass,
      color: "#00FFA3",
    },
  ];
    ...
    <main className="bg-[#060608] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            <p className="font-sans font-light text-lg text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              We don&apos;t just tell stories; we build worlds. Our brand
              narratives define the emotional infrastructure that connects you
              to your audience.
            </p>
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            ...
            <p className="font-heading  text-[16px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              ...
              and amplify the human element in your business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div>
              ...
              <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                ...
                into a narrative that compels action.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Aligning your brand with universal human archetypes for instant familiarity and trust.",
                  },
                  {
                    label: "Conflict & Resolution",
                    desc: "Framing your customer journey as a heroic narrative where your product is the guide.",
                  },
                  {
                    label: "Legacy Engineering",
                    desc: "Building a story that doesn&apos;t just sell today, but builds a brand for the next century.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                step: "01",
                title: "Excavation",
                desc: "Diving deep into your history, values, and vision to find the core truths that make your brand unique.",
              },
              {
                step: "02",
                title: "Weaving",
                desc: "Connecting those truths into a cohesive, multi-layered narrative that works across every platform.",
              },
              {
                step: "03",
                title: "Resonance",
                desc: "Testing and refining the narrative to ensure it lands with maximum impact on your target audience.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize mb-12">
            TELL THE{" "}
            <span className="italic text-[#6324FC]">UNFORGETTABLE.</span>
          </h2>
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to stop being a commodity and start being a character?
            Let&apos;s architect a brand narrative that defines your category.
          </p>
          <button
