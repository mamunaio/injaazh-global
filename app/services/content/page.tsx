  ...
  return (
    <main className="bg-[#060608] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        {/* Stats Strip */}
        <div className="border-b border-white/5 bg-white/[0.01] py-12 md:py-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/5">
            {stats.map((stat, i) => (
              <div key={i} className="py-6 px-6 text-center">
                <div className="font-heading text-5xl md:text-6xl text-white mb-2 uppercase">
                  {stat.value}
                </div>
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {whatIsIncluded.map((item, i) => (
              <div
                key={i}
                className="p-10 bg-white/[0.02] border border-white/5 rounded-3xl hover:border-[#6324FC]/35 transition-all duration-500 flex flex-col justify-between"
              >
                <div>
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {numbersStats.map((stat, idx) => (
              <div
                key={idx}
                className="p-8 rounded-[2.5rem] bg-white/[0.01] border border-white/5 text-center hover:border-white/10 transition-colors"
              >
                <div className="font-heading text-5xl text-white mb-2">
                  {stat.value}
                </div>
                <div className="font-heading text-[10px] tracking-widest text-[#00E5FF] capitalize">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, i) => (
              <div
                key={i}
                className="relative p-8 bg-white/[0.02] border border-white/5 rounded-2xl group hover:border-[#6324FC]/20 transition-colors"
              >
