...
import { ArrowRight, PenTool, Zap, Shield, Globe, Target, MessageSquare, Flame, Sparkles, MousePointer2, Percent, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Sales-focused copy designed to trigger immediate action and drive measurable revenue growth.",
      icon: Target,
      color: "#6324FC"
    },
    {
      title: "Conversion UX",
      description: "Precision micro-copy that guides users through complex interfaces with clarity and confidence.",
      icon: MousePointer2,
      color: "#00E5FF"
    },
    {
      title: "Ad Copy Ops",
      description: "High-performance copy for Google and Meta ads that maximizes CTR and minimizes CPA.",
      icon: Flame,
      color: "#FF2D55"
    },
    {
      title: "Landing Pages",
      description: "Psychology-backed structure and copy that turns traffic into high-value leads and customers.",
      icon: CheckCircle2,
      color: "#00FFA3"
    }
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            <p className="font-sans font-light text-2xl md:text-3xl text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              We write for the bottom line. Our copy doesn&apos;t just sound good; it sells. We engineer every word to trigger the exact action your business needs.
            </p>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              ...
              <div>
                ...
                <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                   Words are the invisible architecture of every sale. We craft every sentence to remove doubt, build desire, and compel the user to click.
                </p>

                <div className="space-y-8">
                   {[
                     { label: "Objection Handling", desc: "Predicting and neutralizing every reason a user might have not to buy before they even think of it." },
                     { label: "Linguistic Precision", desc: "Using high-impact verbs and sensory language to create a vivid image of the product value." },
                     { label: "CTA Engineering", desc: "Testing every button and call-to-action to find the exact phrasing that maximizes conversions." }
                   ].map((item, i) => (
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                { step: "01", title: "Empathy Audit", desc: "Deep-diving into your customer&apos;s pain points, dreams, and hidden desires to find the emotional core." },
                { step: "02", title: "Draft & Test", desc: "Writing high-impact drafts and split-testing headlines to see what resonates most with the actual market." },
                { step: "03", title: "Optimization", desc: "Refining every word based on real-world performance data to ensure long-term conversion stability." }
              ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-2xl mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to turn your website into a high-performance sales machine? Let&apos;s write the copy that converts your visitors into revenue.
          </p>
          <button 
