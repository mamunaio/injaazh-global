  ...
  const features = [
    {
      ...
      description:
        "Visualizing complex data sets into intuitive, real-time dashboards that drive immediate business clarity.",
      icon: BarChart3,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Leveraging historical data and AI models to forecast future market trends and user behavior.",
      icon: TrendingUp,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Deep-diving into competitor performance and industry shifts to find your unique advantage.",
      icon: Globe,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Precision tracking of every marketing dollar and operational hour to maximize total profitability.",
      icon: Target,
      color: "#00FFA3",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            <p className="font-sans font-light text-lg text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              We turn data into dominance. Our intelligence systems provide the
              surgical clarity needed to make high-stakes decisions with
              absolute confidence.
            </p>
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            ...
            <p className="font-heading  text-[16px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              Data without context is just noise. We provide the structural
              intelligence to find the signal in the chaos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div>
              ...
              <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                Stop guessing. We build the data pipelines that tell you exactly
                what is working, what isn&apos;t, and where your next big
                ...
                {[
                  {
                    ...
                    desc: "Connecting your sales, marketing, and ops data into a single source of truth.",
                  },
                  {
                    label: "Predictive Modeling",
                    desc: "Using AI to identify customer churn and lifetime value before it happens.",
                  },
                  {
                    label: "Operational KPIs",
                    desc: "Tracking the metrics that actually matter for your bottom line profitability.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                step: "01",
                title: "Data Mining",
                desc: "Extracting raw data from every touchpoint in your business ecosystem to build a comprehensive data lake.",
              },
              {
                step: "02",
                title: "Modeling",
                desc: "Cleaning and structuring data into logical models that reveal deep patterns and correlations.",
              },
              {
                step: "03",
                title: "Activation",
                desc: "Deploying interactive dashboards and automated alerts that drive strategic business actions.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to lead with data? Let&apos;s build an intelligence system
            that gives you the competitive edge in an increasingly complex
            market.
          </p>
          <button
