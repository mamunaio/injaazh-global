  ...
  const features = [
    {
      ...
      description:
        "Deconstructing outdated systems and rebuilding them with modern, scalable, and secure architectures.",
      icon: RefreshCw,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Moving your entire operation to the cloud with serverless and microservices-based ecosystems for 99.9% uptime.",
      icon: Globe,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Implementing custom AI models and automation tools that radically improve decision-making and efficiency.",
      icon: Brain,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Transforming raw data into actionable business intelligence through advanced analytics and visualization.",
      icon: Database,
      color: "#00FFA3",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            <p className="font-sans font-light text-lg text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              We future-proof your business. Our transformation strategies move
              you from legacy constraints to a world of infinite digital
              possibility.
            </p>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-12">
              <div className="relative w-full h-full flex flex-col justify-between">
                <div className="flex justify-between items-start">
                  <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-white/20">
                    Legacy
                  </div>
                  <ArrowRight className="w-8 h-8 text-[#6324FC] mt-4" />
                  <div className="w-16 h-16 bg-[#6324FC] border border-[#6324FC]/30 rounded-xl flex items-center justify-center text-white shadow-[0_0_20px_rgba(99,36,252,0.5)]">
                    Future
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="font-heading  text-[9px] tracking-[0.5em] text-white/40 capitalize ">
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            ...
            <p className="font-heading  text-[16px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              Transformation is not a destination; it is a continuous process of
              evolution and adaptation to the digital landscape.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div>
              ...
              <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                The cost of doing nothing is the highest cost of all. We provide
                the technical expertise and strategic vision to rebuild your
                organization for the modern era.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Reducing overhead costs by automating complex manual workflows and optimizing resource allocation.",
                  },
                  {
                    label: "Security First",
                    desc: "Protecting your digital assets with enterprise-grade encryption and decentralized architectures.",
                  },
                  {
                    label: "Scalable DNA",
                    desc: "Ensuring your business can handle 100x traffic spikes without breaking a sweat.",
                  },
                ].map((item, i) => (
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize mb-24 text-center">
            THE TRANSFORMATION{" "}
            <span className="italic text-[#6324FC]">CYCLE.</span>
          </h2>
            ...
            {[
              {
                step: "01",
                title: "Discovery",
                desc: "Mapping out your entire technical landscape and identifying the critical friction points in your operations.",
              },
              {
                step: "02",
                title: "Re-engineering",
                desc: "Designing and building the modern, cloud-native infrastructure that will power your future growth.",
              },
              {
                step: "03",
                title: "Scale-up",
                desc: "Seamlessly migrating your data and users to the new system while monitoring performance in real-time.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to break free from legacy limitations? Let&apos;s build a
            digital ecosystem that grows with your vision and dominates your
            market.
          </p>
          <button
          ...
          >
            ...
            <div className="relative w-full h-full md:px-16 px-8 py-4 md:py-8 text-xl md:text-2xl rounded-full bg-[#060608] transition-colors duration-500 flex items-center justify-center gap-6 z-10">
              ...
              <span className="relative z-10 font-heading text-lg md:text-2xl tracking-widest text-white uppercase text-center flex items-center gap-6">
                START TRANSFORMATION STUDY</span>
