  ...
  const features = [
    {
      ...
      description:
        "Capturing high-intent search traffic with surgical precision and industry-leading click-through rates.",
      icon: Search,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Driving massive brand awareness and direct-response sales through advanced social targeting algorithms.",
      icon: Users2,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Recapturing lost visitors and maximizing lifetime value through intelligent cross-channel retargeting funnels.",
      icon: Rocket,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Implementing end-to-end attribution models to ensure every dollar spent is accounted for in revenue.",
      icon: BarChart4,
      color: "#00FFA3",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            <p className="font-sans font-light text-lg text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              ...
              engineered for maximum ROAS and rapid global scalability.
            </p>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
              <div className="font-heading text-8xl text-white tracking-tighter shadow-text animate-pulse">
                8.4X
              </div>
                ...
                {[
                  {
                    ...
                    desc: "AI-driven bidding strategies that optimize for conversion value in real-time.",
                  },
                  {
                    label: "Dynamic Creatives",
                    desc: "Automated ad testing to ensure the most resonant message always wins.",
                  },
                  {
                    label: "Funnel Shielding",
                    desc: "Protecting your brand from low-quality traffic and bot clicks.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                ...
                desc: "Analyzing your customer journey to identify the highest leverage points for paid traffic injection.",
              },
              {
                step: "02",
                title: "Campaign Launch",
                desc: "Deploying multi-channel campaigns across Google, Meta, and LinkedIn with surgical audience targeting.",
              },
              {
                step: "03",
                title: "Aggressive Scaling",
                desc: "Continuously monitoring performance and increasing spend on winning campaigns to maximize total revenue.",
              },
            ].map((s, i) => (
