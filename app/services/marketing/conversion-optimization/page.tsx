  ...
  const features = [
    {
      ...
      description:
        "Executing data-driven experiments to identify the exact layout and copy that drives maximum user action.",
      icon: Microscope,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Leveraging cognitive biases and psychological triggers to eliminate friction and nudge users toward conversion.",
      icon: Brain,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Visualizing exactly where your users click, scroll, and hesitate to identify and fix leakage points.",
      icon: Eye,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Redesigning checkout and lead-gen flows to ensure the absolute smoothest path from click to cash.",
      icon: Filter,
      color: "#00FFA3",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize max-w-xl">
              THE ART OF{" "}
              <span className="italic text-[#6324FC]">REVENUE GENERATION.</span>
            </h2>
            <p className="font-heading  text-[16px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              ...
              user journey is mathematically perfect.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Identifying and eliminating every unnecessary step in your checkout and signup flows.",
                  },
                  {
                    label: "Social Proofing",
                    desc: "Strategically placing authority signals to build instant trust with first-time visitors.",
                  },
                  {
                    label: "Urgency Ops",
                    desc: "Implementing ethical scarcity and urgency triggers to drive immediate action.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                step: "01",
                title: "Hypothesis",
                desc: "Using quantitative and qualitative data to identify the highest leverage testing opportunities on your site.",
              },
              {
                step: "02",
                title: "Experiment",
                desc: "Designing and deploying split-tests to validate our theories and find the winning user experience.",
              },
              {
                step: "03",
                title: "Deployment",
                desc: "Implementing the winners permanently while moving on to the next phase of the continuous growth cycle.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Your traffic is expensive. Don&apos;t waste it. Let&apos;s build a
            conversion engine that extracts maximum value from every single
            visitor.
          </p>
          <button
