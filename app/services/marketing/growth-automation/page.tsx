  ...
  const features = [
    {
      ...
      description:
        "Engineering self-optimizing marketing funnels that nurture leads and close sales while you sleep.",
      icon: Network,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Deep integration with Salesforce, HubSpot, and Pipedrive to ensure absolute data transparency.",
      icon: Database,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Hyper-personalized, behavior-triggered email sequences that drive 4x higher engagement rates.",
      icon: MessageSquare,
      color: "#FF2D55",
    },
    {
      title: "Lead Scoring",
      description:
        "AI-driven algorithms that identify your most valuable prospects based on real-time behavioral data.",
      icon: Cpu,
      color: "#00FFA3",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize max-w-xl">
              SYSTEMS THAT{" "}
              <span className="italic text-[#6324FC]">NEVER SLEEP.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                ...
                high-performance growth machine using the world&apos;s most
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize mb-24 text-center">
            THE AUTOMATION{" "}
            <span className="italic text-[#6324FC]">ROADMAP.</span>
          </h2>
            ...
            {[
              {
                step: "01",
                title: "Stack Audit",
                desc: "Identifying friction points and repetitive tasks within your current marketing and sales infrastructure.",
              },
              {
                step: "02",
                title: "Logic Design",
                desc: "Mapping out complex conditional workflows that handle lead routing, nurturing, and data synchronization.",
              },
              {
                step: "03",
                title: "Autonomous Ops",
                desc: "Deploying and monitoring self-correcting systems that scale your growth with minimal human intervention.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to stop doing the work and start managing the system?
            Let&apos;s build an automation engine that scales your brand
            effortlessly.
          </p>
          <button
          ...
          >
            ...
            <div className="relative w-full h-full md:px-16 px-8 py-4 md:py-8 text-xl md:text-2xl rounded-full bg-[#060608] transition-colors duration-500 flex items-center justify-center gap-6 z-10">
              ...
              <span className="relative z-10 font-heading text-lg md:text-2xl tracking-widest text-white uppercase text-center flex items-center gap-6">
                INITIATE AUTOMATION STUDY</span>
