        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whatIsIncluded.map((item, i) => (
              <div
                key={i}
                className="p-10 bg-white/[0.02] border border-white/5 rounded-3xl hover:border-[#6324FC]/30 transition-all duration-500 flex flex-col justify-between"
              >
                <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {item.tags.map((tag, j) => (
                    <span
                      key={j}
                      className="px-4 py-1.5 bg-white/[0.05] border border-white/5 font-heading text-[10px] tracking-widest text-white/40 uppercase rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {whyItWorks.map((item, i) => (
              <div
                key={i}
                className="space-y-6 border-l border-white/5 pl-8 hover:border-[#6324FC] transition-colors duration-500"
              >
