...
import { ArrowRight, Search, Zap, Shield, Globe, Target, BarChart, MessageSquare, ListFilter, Brain, Filter, TrendingUp } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Mapping out entire topic clusters and LSI keywords to ensure you own the topical authority in your niche.",
      icon: Brain,
      color: "#6324FC"
    },
    {
      title: "Competitor Gaps",
      description: "Identifying the exact keywords your competitors are ranking for and where they are failing to capture intent.",
      icon: ListFilter,
      color: "#00E5FF"
    },
    {
      title: "Intent Mapping",
      description: "Categorizing keywords by Informational, Navigational, and Transactional intent to align with your sales funnel.",
      icon: Target,
      color: "#FF2D55"
    },
    {
      title: "High-ROI Targets",
      description: "Focusing on low-competition, high-intent &quot;hidden gem&quot; keywords that drive immediate revenue.",
      icon: TrendingUp,
      color: "#00FFA3"
    }
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          <div>
            ...
            >
              ...
              <span className="font-heading  text-[#6324FC] text-[10px] tracking-[0.5em] capitalize ">Search Intelligence</span>
            </motion.div>
            
            <h1 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize mb-16">
              KEYWORD <br/>
              <span className="stroke-text text-transparent italic opacity-40">STRATEGY.</span>
            </h1>
            ...
            <p className="font-sans font-light text-2xl md:text-3xl text-white/40 max-w-2xl leading-relaxed border-l-2 border-[#6324FC] pl-8 mb-16">
              We don&apos;t just chase volume; we chase conversion. Our keyword strategies are engineered to capture the exact intent of your most valuable customers.
            </p>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center p-12">
               <div className="font-heading text-6xl text-white tracking-tighter opacity-10 group-hover:opacity-100 transition-all duration-700">USER INTENT</div>
               <div className="font-heading  text-[10px] tracking-[0.8em] text-[#6324FC] capitalize mt-4">Semantic Mapping</div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize max-w-xl">
              TARGETING WITH <span className="italic text-[#6324FC]">SURGICAL INTENT.</span>
            </h2>
            <p className="font-heading  text-[11px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              Finding the right keywords is about understanding the human psychology behind the search query.
            </p>
          </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div className="relative aspect-square bg-[#0A0A0C] border border-white/10 rounded-3xl p-10 shadow-2xl shadow-black overflow-hidden flex flex-col justify-between">
                 <div className="flex justify-between items-start">
                    ...
                    <div className="font-heading  text-[9px] text-white/20 capitalize tracking-[0.3em]">Intent Funnel // v2.0</div>
                 </div>

                 <div className="flex-1 flex flex-col justify-center space-y-4">
                    {[
                      { label: "Informational", val: "Awareness", width: "100%", opacity: 0.1 },
                      { label: "Navigational", val: "Consideration", width: "80%", opacity: 0.3 },
                      { label: "Transactional", val: "Action", width: "60%", opacity: 0.6 },
                      { label: "High-Intent", val: "Revenue", width: "40%", opacity: 1 }
                    ].map((step, i) => (
                      <div key={i} className="space-y-2">
                         <div className="flex justify-between items-end">
                            <span className="font-heading text-xl text-white capitalize ">{step.label}</span>
                            <span className="font-heading  text-[9px] text-white/30 capitalize tracking-widest">{step.val}</span>
                         </div>
              ...
              <div>
                ...
                <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                   Keywords are the breadcrumbs of user intent. We analyze how your customers talk, search, and behave to build a comprehensive search universe for your brand.
                </p>

                <div className="space-y-8">
                   {[
                     { label: "Topic Clusters", desc: "Building silos of content that signal deep expertise to search engines." },
                     { label: "Long-tail Logic", desc: "Capturing hyper-specific queries that have lower competition but 4x higher conversion." },
                     { label: "Seasonal Strategy", desc: "Predicting search trends before they happen to give you the first-mover advantage." }
                   ].map((item, i) => (
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                { step: "01", title: "Mining", desc: "Using advanced AI tools and manual research to discover high-potential keywords your competitors are missing." },
                { step: "02", title: "Clustering", desc: "Grouping thousands of keywords into logical topic clusters to build massive topical authority." },
                { step: "03", title: "Funneling", desc: "Directing the right keywords to the right pages to ensure maximum user relevance and conversion." }
              ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-2xl mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to stop guessing and start dominating? Let&apos;s build a keyword strategy that puts your brand in front of the right audience at the right time.
          </p>
          <button 
