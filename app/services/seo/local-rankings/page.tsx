  ...
  const features = [
    {
      title: "GMB Dominance",
      description:
        "Optimizing your Google Business Profile to ensure you rank #1 in the local map pack for high-intent searches.",
      icon: MapPin,
      color: "#6324FC",
    },
    {
      ...
      description:
        "Crafting location-specific landing pages that resonate with local audiences and satisfy geo-intent.",
      icon: Navigation,
      color: "#00E5FF",
    },
    {
      ...
      description:
        "Building consistent and authoritative local citations across the web to solidify your business authority.",
      icon: Building2,
      color: "#FF2D55",
    },
    {
      ...
      description:
        "Implementing automated systems to gather and manage high-quality local reviews that build trust.",
      icon: Star,
      color: "#00FFA3",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="py-16 md:py-24 border-b border-white/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
            ...
            <p className="font-heading  text-[16px] tracking-widest text-white/30 capitalize max-w-xs leading-loose">
              ...
              optimize all three to put you on the map.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative aspect-square bg-[#0A0A0C] border border-white/10 rounded-3xl p-10 shadow-2xl shadow-black overflow-hidden flex flex-col justify-between">
              ...
              <div className="flex-1 flex flex-col justify-center space-y-6">
                {[
                  ...
                  <div
                    key={i}
                    className={`p-6 rounded-2xl border transition-all duration-500 ${biz.active ? "bg-[#6324FC]/10 border-[#6324FC]/30" : "bg-white/[0.02] border-white/5 opacity-40"}`}
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <div
                        className={`font-heading text-3xl ${biz.active ? "text-[#6324FC]" : "text-white/20"}`}
                      >
                        {biz.rank}
                      </div>
                    </div>
            ...
            <div>
              ...
              <p className="font-sans font-light text-xl text-white/40 mb-12 leading-relaxed">
                ...
                prominent, relevant, and trusted option on the screen.
              </p>
              ...
              <div className="space-y-8">
                {[
                  {
                    label: "Mobile First",
                    desc: "Optimizing for the &quot;Near Me&quot; generation who search while on the move.",
                  },
                  {
                    label: "Voice Search",
                    desc: "Structuring content for Siri, Alexa, and Google Assistant local queries.",
                  },
                  {
                    label: "High Conversion",
                    desc: "Driving direct actions: calls, directions, and website visits.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                step: "01",
                title: "Map Audit",
                desc: "Analyzing your current map presence and identifying inconsistencies in NAP (Name, Address, Phone) data.",
              },
              {
                step: "02",
                title: "Citation Blast",
                desc: "Synchronizing your business data across premium directories and local map engines for maximum authority.",
              },
              {
                step: "03",
                title: "Review Loop",
                desc: "Implementing a continuous feedback system that boosts your reputation and ranking prominence.",
              },
            ].map((s, i) => (
        ...
        <div className="text-center py-16 md:py-24 border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-lg mb-16 max-w-2xl mx-auto leading-relaxed">
            Ready to become the local market leader? Let&apos;s put your
            business on the map and drive more high-intent traffic to your door.
          </p>
          <button
