  ...
  return (
    <main className="w-full bg-[#060608] min-h-screen pt-32 pb-24 text-white font-sans overflow-hidden">
          ...
          <div className="lg:w-3/5 p-12 lg:p-24 flex flex-col justify-center space-y-12 relative z-10">
            ...
            <div className="flex items-center gap-6 pt-4">
               ...
               <p className="font-mono text-[9px] tracking-widest text-white/20 uppercase">
                 Trusted by 5,000+ digital architects
               </p>
            </div>
          </div>
      ...
      <section className="px-6 lg:px-12 max-w-[1400px] mx-auto text-center py-32 border-t border-white/5">
        ...
        <h2 className="font-heading text-6xl md:text-8xl lg:text-9xl leading-[0.9] tracking-tighter uppercase mb-12 text-transparent border-text">
          LET'S SCALE <br/>WORLDWIDE.
        </h2>
        <button 
          onClick={() => openModal()}
