...
const jobs = [
  {
    ...
    requirements: [
      ...
      "Expertise in Core Web Vitals",
      "Experience with Headless CMS (Sanity/Contentful)",
    ],
  },
  {
    ...
    requirements: [
      "Proven track record in Technical SEO",
      "Expertise in Search Console & Ahrefs",
  ...
  },
  {
    ...
    requirements: [
      "$50k+ monthly spend management",
      "Data-driven mindset",
      "Expertise in conversion tracking",
    ],
  },
];
    ...
    <main className="bg-[#060608] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <section className="pt-32 pb-16 md:pt-40 md:pb-24 border-b border-white/5">
          ...
          <p className="font-sans font-light text-lg  text-white/70 max-w-3xl leading-relaxed border-l-2 border-[#6324FC] pl-8">
            We don't hire employees. We recruit elite digital architects and
            growth hackers to build the infrastructure of 2027.
          </p>
        </section>
            ...
            {[
              {
                icon: Globe,
                title: "100% Remote",
                desc: "Work from anywhere on Earth. We value output over office hours.",
              },
              {
                icon: Zap,
                title: "Elite Velocity",
                desc: "We move fast, ship daily, and dominate markets with technical precision.",
              },
              {
                icon: Heart,
                title: "Growth Budget",
                desc: "Unlimited books, courses, and conferences to sharpen your lethal edge.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <h3 className="font-heading text-3xl text-white mb-4 capitalize ">
                  {item.title}
                </h3>
                <p className="font-sans font-light text-white/40  leading-relaxed">
                  {item.desc}
                </p>
              </motion.div>
            ))}
        ...
        <section className="py-16 md:py-24 border-b border-white/5">
          <div className="flex items-center justify-between mb-20">
            <h2 className="font-heading text-5xl md:text-7xl leading-[0.85] tracking-tighter text-white capitalize ">
              Open <span className="italic text-[#6324FC]">Missions</span>
            </h2>
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <span className="font-heading  text-[9px] tracking-widest text-[#6324FC] px-3 py-1 bg-[#6324FC]/10 rounded-full">
                        {job.type}
                      </span>
                    ...
                    <h3 className="font-heading text-3xl lg:text-4xl text-white group-hover:text-[#6324FC] transition-colors">
                      {job.title}
                    </h3>
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {job.requirements.map((req, i) => (
                            <li
                              key={i}
                              className="flex items-center gap-3 font-sans text-sm text-white/40"
                            >
        ...
        <section className="py-16 md:py-24 text-center border-t border-white/5">
          ...
          <p className="font-sans text-white/40 text-xl mb-12 max-w-xl mx-auto italic">
            "If you are exceptionally lethal at what you do, we will create a
            mission for you."
          </p>
          <Link
            href="/contact"
            className="font-heading  text-sm tracking-widest text-[#6324FC] hover:text-white transition-colors border-b border-[#6324FC]"
          >
