    ...
    <main className="w-full min-h-screen bg-[#060608] text-white relative overflow-hidden selection:bg-[#00E5FF] selection:text-[#060608]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <div className="font-heading  text-[#00E5FF] tracking-[0.5em] text-[10px] capitalize mb-8 flex items-center gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-32">
          ...
          <div className="lg:w-1/3 hidden lg:block">
            <div className="sticky top-40 space-y-8">
              <h4 className="font-heading  text-[10px] text-white/30 tracking-widest capitalize mb-8">Master Service Agreement</h4>
          ...
          <div className="lg:w-2/3">
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              >
                ...
                <h3 className="font-heading text-4xl tracking-tight capitalize mb-6 text-white relative z-10">Questions Regarding Terms?</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-6 relative z-10">
                  ...
                  <a href="mailto:legal@injaazh.com" className="inline-flex items-center justify-center gap-3 px-8 py-5 border border-white/20 text-white font-heading text-sm tracking-widest capitalize rounded-full hover:bg-white/5 transition-colors">
                    Email Legal Team
                  </a>
                </div>
              </motion.div>
