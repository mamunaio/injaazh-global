...
export default function UIUXPage() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#060608] text-white pt-32 pb-20 font-sans overflow-hidden">
      ...
      <section className="px-6 lg:px-12 max-w-[1400px] mx-auto mb-32">
        <h2 className="font-heading text-4xl md:text-6xl uppercase mb-16">WHY INJAAZH DESIGN WORKS</h2>
      ...
      {/* OUR DESIGN PROCESS */}
      <section className="px-6 lg:px-12 max-w-[1400px] mx-auto mb-32">
        <h2 className="font-heading text-4xl md:text-6xl uppercase mb-16">OUR DESIGN PROCESS</h2>
      ...
      <section className="px-6 lg:px-12 max-w-[1400px] mx-auto text-center py-32 border-t border-white/5">
        <h2 className="font-heading text-5xl md:text-7xl mb-8 uppercase">Ready to Dominate Design?</h2>
