  ...
  return (
    <>
      <motion.header 
        ...
        animate={{
          backgroundColor: isScrolled || isHovered ? "var(--bg-opacity-80)" : "transparent",
          backdropFilter: isScrolled || isHovered ? "blur(12px)" : "blur(0px)",
          borderBottom: isScrolled || isHovered ? "1px solid var(--border-opacity-10)" : "1px solid transparent",
          paddingTop: isScrolled ? "0px" : "16px",
        }}
              ...
              <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12">
                <div className="grid grid-cols-12 gap-8">
                  ...
                  >
                    ...
                    <Link href="/work/01" onClick={() => setIsHovered(false)} className="group relative block overflow-hidden rounded-none cursor-pointer">
              ...
              {["Work", "Services", "Agency", "Insights", "Team", "Contact"].map((item, i) => (
                ...
                >
                  <Link 
                    ...
                    className="font-heading text-6xl tracking-widest text-primary hover:text-[#6324FC] transition-colors flex items-center justify-between group"
                  >
                    {item}
                    <ArrowRight className="w-8 h-8 text-[#6324FC] opacity-0 group-hover:opacity-100 transition-opacity" />
                  </Link>
                  <div className="w-full h-[1px] bg-primary/10 mt-6" />
                </motion.div>
              ))}
            </nav>
