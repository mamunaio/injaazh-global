        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-32">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading text-8xl md:text-[9rem] tracking-tighter text-white leading-[0.85] uppercase">
              THE MINDS BEHIND <br/>
              <span className="stroke-text text-transparent italic opacity-40">INJAAZH.</span>
            </h2>
          </div>
          <motion.div 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-32">
          {teamPreviewData.map((member, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-[1500ms] ease-out">
                <Image 
                  src={member.image}
                  alt={member.name}
                  fill
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 lg:p-10 flex flex-col z-10">
                <div className="w-8 h-[2px] bg-[#6324FC] mb-6 group-hover:w-16 transition-all duration-700 ease-out" />
                
                <div className="inline-flex w-fit px-3 py-1.5 bg-[#6324FC]/20 backdrop-blur-md border border-[#6324FC]/30 rounded-full font-mono text-[10px] lg:text-[11px] tracking-[0.2em] text-[#E0D4FF] uppercase mb-4 group-hover:bg-[#6324FC] group-hover:border-[#6324FC] group-hover:text-white transition-all duration-500">
                  {member.role}
                </div>
