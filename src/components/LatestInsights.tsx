        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-32">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading text-8xl md:text-[9rem] tracking-tighter text-white leading-[0.85] uppercase">
              INSIGHTS THAT <br/>
              <span className="stroke-text text-transparent italic opacity-40">DRIVE GROWTH.</span>
            </h2>
          </div>
          <motion.div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 mb-32">
          {posts.map((post, idx) => (
            ...
            >
              ...
              {/* Image Container */}
              <Link href="/blog" className="relative h-72 w-full overflow-hidden block">
                <Image 
                  src={post.image}
                  alt={post.title}
                  fill
              ...
              <div className="p-10 lg:p-12 flex flex-col flex-1 relative z-10">
                ...
                <div className="mt-auto pt-8 border-t border-white/5">
                  <Link href="/blog" className="inline-flex items-center gap-5 text-white/40 font-heading tracking-[0.2em] text-[10px] group/btn uppercase transition-all duration-500 hover:text-white hover:gap-8">
