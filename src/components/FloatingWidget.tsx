  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
      ...
      >
        ...
        <button className="w-14 h-14 bg-white dark:bg-zinc-900 backdrop-blur-xl border border-black/5 dark:border-white/10 flex items-center justify-center text-zinc-900 dark:text-white hover:border-[#6324FC] transition-all duration-500 shadow-xl rounded-2xl group relative overflow-hidden">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button 
            ...
            onClick={scrollToTop}
            className="w-14 h-14 bg-[#6324FC] flex items-center justify-center text-white shadow-[0_15px_35px_rgba(99,36,252,0.3)] hover:bg-[#5219d6] transition-all duration-500 rounded-2xl group"
          >
